...
class RefundPaymentGateway
{
    ...
    {
        $this->transactionRequestType->setTransactionType("refundTransaction");
        $this->transactionRequestType->setAmount($this->input['refundAmount']);
        $this->transactionRequestType->setPayment($this->paymentType);
        $this->transactionRequestType->setRefTransId($this->input['getTransId']);
