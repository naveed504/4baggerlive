    ...
    <div class="container mb-5">
        ...
        <div class="row">
            <div class="col-sm-10 mx-auto border p-0">
                ...
                <form action="{{route('updateplayerprofile')}}" enctype="multipart/form-data" method="post" id="player_registration_form" >
                    @csrf
                                 <div class="col-sm-12 mt-2 p-4">
                                               <div class="form-row">
                                                <div class="form-group col-md-6 col__mr-right">
                                                    ...
                                                    <input type="email" class="form-control input__box--wrapper"  placeholder="" value="{{ Auth::user()->email }}" name="email" required>
                                                    @if($errors->has('email'))
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6 col__mr-right">
                                                    <label class="label__wrapper required" for="">Player First
                                                        Name</label>
                                                    <input type="text" class="form-control input__box--wrapper"  placeholder="" value="{{ Auth::user()->first_name }}" name="first_name" required>
                                                    @if($errors->has('name'))
                                                        <span class="invalid-feedback">
                                                ...
                                                <div class="form-group col-md-6 col__mr-right">
                                                    <label class="label__wrapper required" for="">Player Last
                                                        Name</label>
                                                    <input type="text" class="form-control input__box--wrapper"  placeholder="" value="{{ Auth::user()->last_name }}" name="last_name" required>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6 col__mr-right">
                                                    ...
                                                    <input type="text" class="form-control input__box--wrapper phoneNumber"  placeholder="" value="{{ Auth::user()->cell_number }}" name="cell_no" required>
                                            ...
                                            @for($i = 0; $i < count((array)json_decode(Auth::user()->player['parents_f_name'] ?? '' )) ; $i++)
                                                <div class="form-row" id="parentinfo">
                                                    <div class="form-group col-md-6 col__mr-right">
                                                        ...
                                                        <input type="text" class="form-control input__box--wrapper"  placeholder="" value="{{ json_decode(Auth::user()->player->parents_f_name)[$i] }}" name="parent_firstname[]" required>
                                                    ...
                                                    <div class="form-group col-md-6 col__mr-right">
                                                        ...
                                                        <input type="text" class="form-control input__box--wrapper"  placeholder="" value="{{ json_decode(Auth::user()->player->parents_l_name)[$i] }}" name="parent_lastname[]" required>
                                                ...
                                                <div class="form-row" id="parentcontact">
                                                    ...
                                                    <div class="form-group col-md-6 col__mr-right">
                                                        ...
                                                        <input type="text" class="form-control input__box--wrapper phoneNumber"  placeholder="" value="{{ json_decode(Auth::user()->player->parents_cell_number)[$i] }}" name="parent_cellno[]" required>
                                                    ...
                                                    <div class="form-group col-md-6 col__mr-right">
                                                        ...
                                                        <input type="email" class="form-control input__box--wrapper"  placeholder="" value="{{ json_decode(Auth::user()->player->parents_email)[$i] }}" name="parent_email[]" required>
