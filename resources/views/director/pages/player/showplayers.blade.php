   ...
   <section class="mt--top-40 mb-5">
        ...
        <div class="col-md-10 offset-md-2">
            ...
            <div class="row">
                ...
                <div class="col-md-6 ">
                        <form method="post" action="{{ route('search_player_in_director') }}">
                            @csrf
            ...
            @forelse ($players as $player)
                <div class="row mb-4 mt-5">
                    ...
                    <div class="col-sm-5 col-md-5 col-lg-5">
                        <a class="btn btn--wrapper text-dark" href="{{ route('view_player_profile_in_director', $player->user->id) }}">Profile</a>
