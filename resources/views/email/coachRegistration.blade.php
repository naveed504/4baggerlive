...
<body style="background-color: #f0f0f0;">
    <table style="background-color: #fff; width: 60%; margin: auto;">
        ...
        <tr>
            <td style="text-align: center;">
                <h2 style="margin-top: 40px; font-size: 26px; font-weight: 400; font-family: 'Roboto-Bold';">Team Coach 
                    </h2>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="text-align: center;">
                <div style="width: 600px; margin: auto;">
                    ...
                    <p style="font-size: 17px; font-weight: 400; font-family: 'Roboto-Regular'; color: #645e69;">Dear  <strong> {{ $data['name'] }} </strong> you are registered with team <strong>{{ $data->team[0]['team_name'] }}</strong> successfully.</p>
                    <p style="color: green; font-size: 22px; font-weight: 400; font-family: 'Roboto-Bold';"><span>Account Status:</span> <span style="color:rgb(45, 194, 45)">Active</span></p>
