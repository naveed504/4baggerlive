...
<body style="background-color: #f0f0f0;">
    <table style="background-color: #fff; width: 60%; margin: auto;">
        ...
        <tr>
            <td style="text-align: center;">
                <h2 style="margin-top: 40px; font-size: 26px; font-weight: 400; font-family: 'Roboto-Bold';">Director Account Request 
                    </h2>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="text-align: center;">
                <div style="width: 600px; margin: auto;">
                    <h4 style=" font-size: 22px; font-weight: 400; font-family: 'Roboto-Bold';">Hello {{ $data['name'] }}</h4>
                    <p style="font-size: 17px; font-weight: 400; font-family: 'Roboto-Regular'; color: #645e69;">Lorem
                        ...
                        <a href="http://www.4bagger.leadconcept.info/admin/unapproved/directors" style="background-color: #459413; color: #fff; text-transform: uppercase; font-size: 17px; font-family: 'Roboto-Bold'; border: 2px solid #459413; padding: 9px 18px; border-radius: 8px;text-decoration:none;
                         box-shadow: 0px 0px 4px 2px rgb(211 211 211);">Approve Director Request</a>
                    <p
