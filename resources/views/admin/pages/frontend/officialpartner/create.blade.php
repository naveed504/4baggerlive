...
<div class="row">
    ...
    <div class="container mb-5">
        <br><br>
        <form action="  {{ route('officialpartner.store') }} " method="post" id="" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-sm-10 mx-auto border p-0">
                    ...
                    <strong>Home Official Partner  Information </strong>
                    </p>
                    <div class="col-sm-12 mt-2 p-4">
                        <div class="row mb-2">
                                ...
                                <div class="col-sm-6">
                                <label class="label__wrapper ">Partner Photo </label><span class="imgsixeofspan">Size(1024*720px)</span>
