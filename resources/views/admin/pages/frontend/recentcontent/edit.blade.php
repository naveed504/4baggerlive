...
<div class="row">
     <div class="col-sm-12">
            ...
            Edit  Recent Content Section
            </h4>
    </div>
    <div class="container mb-5">
                <br><br>
        <form action="  {{ route('recentcontent.update', $editcontentsection->id ) }} " method="post" id="" enctype="multipart/form-data">
                    ...
                    <div class="col-sm-12 mt-2 p-4">
                        <div class="row mb-2">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" name="title" class="form-control input__box--wrapper" value="{{ $editcontentsection->title }}" >
                                    @error('title')
                                    <div class="error text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-sm-6">
                                <label class="label__wrapper ">Home Section Photo </label><span class="imgsixeofspan">Size(1024*720px)</span>
                            ...
                            <div class="row mb-2">
                                <div class="col-sm-12">
                                    ...
                                    <textarea  name="detail" class="form-control input__box--wrapper" id="summernote" >{{ $editcontentsection->detail }} </textarea>
                                    @error('detail')
                                    <div class="error text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
