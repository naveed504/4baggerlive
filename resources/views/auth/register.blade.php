                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6 col__mr-right">
                                                    ...
                                                    <select class="form-control  input__box--wrapper down-icons" name="age_group" required>
                                                        ...
                                                        <option value="2"> 6U</option>
                                                        <option value="3"> 7U</option>
                                                        <option value="4"> 8U</option>
                                                        <option value="5"> 9U</option>
                                                        <option value="6">10U</option>
                                                        <option value="7">11U</option>
                                                        <option value="8">12U</option>
                                                        <option value="9">13U</option>
                                                        <option value="10">14U</option>
                                                        <option value="11">15U</option>
                                                        <option value="12">16U</option>
                                                        <option value="13">17U</option>
                                                        <option value="14">18U</option>
                                                    </select>
                                                ...
                                                <div class="flex__cotent--wrapper">
                                                    <div class="mr__right20">
                                                        ...
                                                        <select class="form-control  input__box--wrapper down-icons" name="month">
                                                            ...
                                                            @for($i = 1; $i < 13; $i++ ) <option value="{{ $i }}">{{ date("F", mktime(0, 0, 0, $i, 10)) }}</option>
                                                                @endfor
                                                        </select>
                                                        @if($errors->has('month'))
                                                        <span class="invalid-feedback">
                                                    ...
                                                    <div class="mr__right20">
                                                        ...
                                                        <select class="form-control  input__box--wrapper down-icons" name="year" required>
                                                            ...
                                                            @for($i=$lastYear; $i<$currentYear; $i++) <option value="{{$i}}">{{$i}}</option>
                                                                @endfor
                                                        </select>
                                                        @if($errors->has('year'))
                                                        <span class="invalid-feedback">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6 col__mr-right">
                                                ...
                                                <select class="form-control  input__box--wrapper down-icons" name="graduation_year" required>
                                                    ...
                                                    @for($i=$getyear; $i<$currentyear1; $i++) <option value="{{$i}}">{{$i}}</option>
                                                        @endfor
                                                </select>
